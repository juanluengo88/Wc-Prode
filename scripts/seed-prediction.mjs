...
if (predictPenaltiesWinner && !["HOME_TEAM", "AWAY_TEAM"].includes(predictPenaltiesWinner)) {
...
if (!existing.empty) {
  ...
  await docRef.update({ predictHome, predictAway, predictPenalties, predictPenaltiesWinner });
