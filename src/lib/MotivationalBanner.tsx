		...
		<div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 border border-slate-800 p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
			...
			<div className="space-y-2 text-center md:text-left">
				...
				<h3 className="text-2xl font-black text-white mt-3">
					¡Completa tus pronósticos a tiempo!
				</h3>
				<p className="text-sm text-slate-300 max-w-xl">
					Los partidos se bloquean automáticamente **15 minutos antes** de la
					hora de inicio oficial. Gana{" "}
					<span className="text-amber-400 font-semibold">3 puntos</span> por
					acertar marcador exacto o{" "}
					<span className="text-amber-400 font-semibold">1 punto</span> por
					acertar ganador/empate.
				</p>
			</div>
