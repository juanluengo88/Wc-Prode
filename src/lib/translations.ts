...
const translations = {
	es: {
		...
		bottomNav_standings: "Fase de Grupos",

		// StandingsView
		standings_title: "Posiciones",
		standings_matchday: "Jornada {matchday} · Copa del Mundo 2026",
		standings_loading: "Cargando posiciones...",
		standings_noData: "No hay datos disponibles",
		standings_groupPrefix: "Grupo {letter}",
		standings_colTeam: "Equipo",
		standings_colPJ: "PJ",
		standings_colW: "G",
		standings_colD: "E",
		standings_colL: "P",
	...
	en: {
		...
		bottomNav_standings: "Group Standings",

		// StandingsView
		standings_title: "Stage Group Standings",
		standings_matchday: "Matchday {matchday} · World Cup 2026",
		standings_loading: "Loading standings...",
		standings_noData: "No data available",
		standings_groupPrefix: "Group {letter}",
		standings_colTeam: "Team",
		standings_colPJ: "MP",
		standings_colW: "W",
		standings_colD: "D",
		standings_colL: "L",
		...
		standings_colGD: "GD",
		standings_colPts: "Pts",
		standings_qualifyLegend: "Advance to Round of 16",
		standings_topScorersTitle: "Top Scorers",
		standings_goalsUnit: "goals",
